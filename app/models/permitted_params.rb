class PermittedParams < Struct.new(:params)
  ...
  def poll_attributes
    [:title, :details, :poll_type, :discussion_id, :group_id, :closing_at, :anonymous,
     ...
     :custom_fields, {custom_fields: [:can_respond_maybe, :deanonymize_after_close, :hide_results_until_close, :dots_per_person, :time_zone, :meeting_duration, :minimum_stance_choices, :pending_emails, {pending_emails: []}]},
